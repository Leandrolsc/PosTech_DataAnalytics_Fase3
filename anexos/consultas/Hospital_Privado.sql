SELECT '112020' as MesAno
        ,COUNT(CASE B0046 WHEN 1 THEN 1 ELSE null END) Privado
        ,COUNT(CASE B0046 WHEN 2 THEN 2 ELSE null END) Publico
        ,COUNT(CASE WHEN NULLIF(B0046,9) is not null THEN 1 ELSE null END) TotalPreenchido
        ,COUNT(*) Total
        ,(COUNT(CASE WHEN NULLIF(B0046,9) is not null THEN 1 ELSE null END)/COUNT(*)) *100 as PercentualPreenchimento
